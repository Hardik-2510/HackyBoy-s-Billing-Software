...
namespace Billing_Software.DAL
{
    internal class categoriesDAL
    {
        ...
        #region Select Method for Categories
        ...
        public bool Insert(categoriesBLL c)
        {
            ...
            try
            {
                string add = "INSERT INTO tbl_categories (title, description , added_date , added_by) VALUES (@title, @description , @added_date , @added_by)";
        ...
        #region Update Categories Method
