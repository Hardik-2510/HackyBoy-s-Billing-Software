...
namespace Billing_Software.DAL
{
    internal class productDAL
    {
        ...
        #region Add Method for Products
        ...
        public bool Insert(productsBLL p)
        {
            ...
            try
            {
                string sql = "INSERT INTO tbl_products (name, category, description, rate, added_date, added_by) VALUES (@name, @category, @description, @rate, @added_date, @added_by)";
                SqlCommand cmd = new SqlCommand(sql, conn);
